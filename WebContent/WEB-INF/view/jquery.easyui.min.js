...
},beforePageText:"页码",afterPageText:"共 {pages}",displayMsg:"当前显示 {from} 至 {to} 共 {total} 行",nav:{first:{iconCls:"pagination-first",handler:function(){
